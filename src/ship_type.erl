...
decode_ship_type(59) -> noncombatant_ship;
decode_ship_type(60) -> passenger_all;
decode_ship_type(61) -> passenger_hazardous_a;
decode_ship_type(62) -> passenger_hazardous_b;
decode_ship_type(63) -> passenger_hazardous_c;
decode_ship_type(64) -> passenger_hazardous_d;
decode_ship_type(X) when X >= 65, X =< 68 -> passenger_reserved;
decode_ship_type(69) -> passenger_no_info;
decode_ship_type(70) -> cargo_all;
decode_ship_type(71) -> cargo_hazardous_a;
decode_ship_type(72) -> cargo_hazardous_b;
decode_ship_type(73) -> cargo_hazardous_c;
decode_ship_type(74) -> cargo_hazardous_d;
decode_ship_type(X) when X >= 75, X =< 78 -> cargo_reserved;
decode_ship_type(79) -> cargo_no_info;
